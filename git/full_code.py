...
ships=pd.read_csv("D:\AG7\train_ship_segmentations_v2.csv")
test_data=pd.read_csv("D:\AG7\sample_submission_v2.csv")
...
def process_images(uploaded_files):
    ...
    for i, file_path in enumerate(uploaded_files):
        ...
        image_path = os.path.join(path, imageid)  # Construct the full image path
    ...
    plt.tight_layout()
    processed_image_path = "processed_images.png"
